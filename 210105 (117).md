...
.![210105_as3](C:\Users\김슬기\Desktop\java 캡쳐\210105_as3.PNG)
...
- 속성값
  ...
  - relative
    ...
    <title>Insert title here</title>
        <style>
            ...
            #yellow {
                ...
                position:relative;
                bottom:100px;					// red의 위치를 기준으로 yellow의
                								// 위치가 정해짐.
            }									// red가 가로, 세로 100인 상태이므로,
    											// bottom 100이면 red의 세로 100
                                   				// 위치에서 위쪽으로 100을 이동하므로,
                                   				// yellow가 red를 가리게 됨.
            #green {
                width:100px; height:100px;
                background-color:green;
                position:relative;			   // green은 yellow가 부모이므로,
                top:0; left:100px;			   // yellow의 왼쪽 상단을 0,0으로
            }								   // 보고 왼쪽으로만 100xp만큼 이동
    ...
    <body>
        <div id="red"></div>						// red, yellow가 동위요소이므로,
        <div id="yellow">							// red가 yellow의 기준이 됨.
            <div id="green"></div> 					// blue, green은 yellow가 부모이므로,
            <div id="blue"></div>					// yellow를 기준으로 함.
        </div>
    </body>
    </html>
    ```
  ...
  - absolute
    ...
    <style>
           ...
           div:nth-child(1) {
               ...
               position:fixed;					// 웹 브라우저 크기가 작아져서 스크롤이
               top:0;							// 생겨도 자리에 고정되어 움직이지 x.
               left:0;							// body 기준으로 0, 0 자리에 위치.
           }
    
           div:nth-child(2) {
               background-color:#00ff00;
               position:absolute;				// static 속성을 가지지 않은 부모 요소가
               top:50px;						// 없으므로, body를 기준으로 50, 50에 위치
               left:50px;
           }
    
           div:nth-child(3) {					// 두 번째 구조 요소와 마찬가지로 static
               background-color:#0000ff;		// 속성을 가진 부모 요소가 없으므로,
               position:absolute;				// body 기준 100, 100에 위치.
               top:100px;
               left:100px;
           }
...
- 쿠키 문법
  ...
  <img src="C:\Users\김슬기\Desktop\java 캡쳐\jsp_cookie.PNG" alt="jsp_cookie" style="zoom:150%;" />
...
- 종류
  ...
  - forward
    ...
    **[ 결과 ]**
    ...
    ![jsp_forwarding](C:\Users\김슬기\Desktop\java 캡쳐\jsp_forwarding.PNG)
  ...
  - include
    ...
    - ![jsp_include](C:\Users\김슬기\Desktop\java 캡쳐\jsp_include.PNG)
  ...
  - param
    ...
    **[ 결과 ]**
    ...
    ![jsp_param](C:\Users\김슬기\Desktop\java 캡쳐\jsp_param.PNG)
...
.![210105_as1](C:\Users\김슬기\Desktop\java 캡쳐\210105_as1.PNG)
...
### 프로그래밍 2. 다음을 프로그래밍하시오.![210105_as2](C:\Users\김슬기\Desktop\java 캡쳐\210105_as2.PNG)
