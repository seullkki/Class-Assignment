...
- < span > 
  ...
  - 사용할 수 있는 속성들
    ...
    ![span](C:\Users\김슬기\Desktop\java 캡쳐\span.PNG)
...
- inline 요소
  ...
  .![blockinline](C:\Users\김슬기\Desktop\java 캡쳐\blockinline.PNG)
...
→ 이 방식들이 실행되는 원리는 실행하고자 하는 내용을 담은 클래스가 httpServlet을 상속하면서 그 안에 doGet, doPost 메소드를 사용할 수 있기 때문.
→ 두 메소드는 모두 request, response를 매개 변수로 받아 객체를 생성하게 됨.
→ 이때 객체를 생성해주는 것은 톰캣임.
→ request 객체는 요청을 한 클라이언트들의 각 주소를 담고 있어 받아놓고, response 객체는 받은 주소를 가지고 있다가 요청이 처리되면 이를 통해 다시 각 클라이언트에게 응답을 줄 수 있도록 함.
```
...
.![html_assign1](C:\Users\김슬기\Desktop\java 캡쳐\html_assign1.PNG)
...
.![html_assign2](C:\Users\김슬기\Desktop\java 캡쳐\html_assign2.PNG)
...
.![html_assign3](C:\Users\김슬기\Desktop\java 캡쳐\html_assign3.PNG)
...
.![html_assign4](C:\Users\김슬기\Desktop\java 캡쳐\html_assign4.PNG)
...
.![html_assign5](C:\Users\김슬기\Desktop\java 캡쳐\html_assign5.PNG)
