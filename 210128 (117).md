...
![jQuery_as1](C:\Users\김슬기\Desktop\java 캡쳐\jQuery_as1.PNG)
...
<head>
  ...
  <style>
  	.bx-wrapper, img{						//.bx-wrapper는 브라우저 디버깅으로 알아냄
	  	width: 440px;						// img css도 브라우저 디버깅으로 적절한 사진의 크기를 구해옴
...
![jQuery_as2](C:\Users\김슬기\Desktop\java 캡쳐\jQuery_as2.PNG)
